...
NOTIFICATION_REASON_TEXT = {
    "hunger": "🍚 お腹が空っぽみたい！ ごはんをあげてね！",
    "mood": "😠 ごきげんが悪いみたい… あそんであげよう！",
    "poop": "💩 うんちを片付けてほしいみたい！",
    "sick": "😷 具合が悪そう… おくすりが必要かも！",
    "sleepy": "😴 かなり眠そう… 休ませてあげよう！",
    "whim": "📢 わがままサイン！ しつけてあげよう！",
}
...
MUSIC_GAMES = {
    "rhythm": {"title": "リズムあそび", "question": "つぎのリズムと同じものはどれ？  ♪ ♪ ♫", "choices": ["♪♪♫", "♪♫♪", "♫♪♪"], "answer": 0},
    "instrument": {"title": "音あて", "question": "メロディを支えることが多いのはどれ？", "choices": ["ドラム", "ピアノ", "ギター"], "answer": 1},
    "melody": {"title": "メロディ記憶", "question": "『ド レ ミ』と同じ並びはどれ？", "choices": ["ドレミ", "レミド", "ドミレ"], "answer": 0},
}
